/**
 * sidebar.js — Sidebar component renderizado dinámicamente
 */
  ...
  sidebar.innerHTML = `
    ...
    <nav class="sidebar-nav">
      ...
      ${NAV_ITEMS.map((item, i) => `
        <a href="${item.hash}"
           class="sidebar-item anim-slide-right delay-${i + 1} ${currentHash === item.hash ? 'active' : ''}"
           data-hash="${item.hash}">
    ...
    <div class="sidebar-user">
      <div class="sidebar-user-inner">
        <div class="flex items-center gap-3" style="margin-bottom:0.625rem;">
...
/** Genera un SVG de Lucide por nombre de icono */
export function lucideIcon(name, size = 18) {
  // Mapeo manual de íconos usados en el proyecto
  const icons = {
    ...
    'arrow-right-2':    `<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>`,
...
/** Formatea fecha muy corta (sin año) */
